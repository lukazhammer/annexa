...
export default function LivePreview({ formData, highlightedField, transformedIntroduction }) {
  ...
  *Generated by Annexa (Vox Animus OÜ) • Template v1.2.3 • Generated: ${currentDate} • Review recommended before use*`;
  };
...
*This Privacy Policy was generated by Annexa (Vox Animus OÜ) and should be reviewed by legal counsel before use.*${getLegalFooter()}`;
  };
...
*Generated by Annexa (Vox Animus OÜ)*${getLegalFooter()}`;
  };
