...
Deno.serve(async (req) => {
  try {
    ...
    const addFooter = () => {
      ...
      const footerText = 'Generated by Annexa • Template v1.2.3 • Review recommended';
    ...
    doc.setFontSize(24);
    doc.setTextColor(0, 0, 0);
    doc.text('Generated by', pageWidth / 2, 40, { align: 'center' });
    ...
    doc.text(`Generated: ${currentDate}`, pageWidth / 2, 95, { align: 'center' });
